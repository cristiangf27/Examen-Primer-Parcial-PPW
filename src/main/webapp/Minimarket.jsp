		...
		<div class="container">
			<div class="row">
				...
				<div class="gallery-slider lightbox">
					...
					<div class="gallery-item">
						<img src="img/tienda.jpg" alt="imagen del negocio" />
					</div>

					<div class="gallery-item">
						<img src="img/T3.jpg" alt="imagen del negocio">
					</div>

					<div class="gallery-item">
						<img src="img/T2.jpg" alt="imagen del negocio">
					</div>

					<div class="gallery-item">
						<img src="img/T1.jpg" alt="imagen del negocio">
					</div>
			...
			<div class="row">
				<div class="col colm-txt">
					<h2 class="fw-bold">
						Minimarket Rosita <span class="badge proyect-badge">RECOMENDADO</span>
				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<p>Comercializan productos de consumo masivo de excelente
								calidad a los mejores precios del mercado, brindando la mejor
								opción en surtido, orientado a satisfacer las necesidades de los
								clientes, acompañado de un buen servicio y atención.</p>
							<!-- Aqui la descripcion del negocio-->
							<hr>
							<h4 class="fw-bold">Horario</h4>
							<p>Lunes - Viernes : 7:30AM - 20PM</p>
							<!-- Aqui el horario del negocio -->
							<p>Sabado - Domingo : 11:00AM - 20PM</p>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-12">
					...
					<div class="business-slider">
						...
						<div class="business">
							<div class="business-img">
								<img alt="Negocio" src="img/Farmacia.jgp"> <span
									class="business-tag">Recomendado</span>
								<!--Calificacion o Detalle-->
							</div>
							<div class="text-left business-content">
