		...
		<div class="container">
			<div class="row">
				...
				<div class="gallery-slider lightbox">
					...
					<div class="gallery-item">
						<img src="img/Restaurante.jpg" alt="imagen del negocio" />
					</div>

					<div class="gallery-item">
						<img src="img/R1.jpg" alt="imagen del negocio">
					</div>

					<div class="gallery-item">
						<img src="img/R2.jpg" alt="imagen del negocio">
					</div>

					<div class="gallery-item">
						<img src="img/R3.jpg" alt="imagen del negocio">
					</div>
			...
			<div class="row">
				<div class="col colm-txt">
					<h2 class="fw-bold">
						Restaurante Juan <span class="badge proyect-badge">9.8</span>
				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<p>Da el mejor servicio a los clientes,con precios
								accesibles y con la mejor calidad de comida
								ecuatoriana,conservando las tradiciones y mejorando la atencion a
								los clientes,colaboradores y proveedores.</p>
							<!-- Aqui la descripcion del negocio-->
							<hr>
							<h4 class="fw-bold">Horario</h4>
							<p>Lunes - Viernes : 7:00AM - 18PM</p>
							<!-- Aqui el horario del negocio -->
							<p>Sabado - Domingo : 8:00AM - 17PM</p>
						</div>
					</div>
