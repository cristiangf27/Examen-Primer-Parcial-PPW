		...
		<div class="container">
			<div class="row">
				...
				<div class="gallery-slider lightbox">
					...
					<div class="gallery-item">
						<img src="img/mecanica.jpg" alt="imagen del negocio" />
					</div>

					<div class="gallery-item">
						<img src="img/M1.jpg" alt="imagen del negocio">
					</div>

					<div class="gallery-item">
						<img src="img/M2.jpg" alt="imagen del negocio">
					</div>

					<div class="gallery-item">
						<img src="img/M3.jpg" alt="imagen del negocio">
					</div>
			...
			<div class="row">
				<div class="col colm-txt">
					<h2 class="fw-bold">
						Mecanica Trujillo <span class="badge proyect-badge">$$</span>
				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<p>Proporcionar un servicio de calidad para brindar
								soluciones fiables y duraderas que conserven los autos en un
								estado óptimo, eficiente y seguro por medio de personal
								altamente capacitado, motivado y productivo que tiene como
								principal interés la seguridad y satisfacción de nuestros
								clientes.</p>
							<!-- Aqui la descripcion del negocio-->
							<hr>
							<h4 class="fw-bold">Horario</h4>
							<p>Lunes - Viernes : 9:00AM - 17PM</p>
							<!-- Aqui el horario del negocio -->
							<p>Sabado - Domingo : 9:00AM - 15PM</p>
						</div>
					</div>
