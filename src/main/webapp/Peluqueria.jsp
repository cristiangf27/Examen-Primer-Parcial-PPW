		...
		<div class="container">
			<div class="row">
				...
				<div class="gallery-slider lightbox">
					...
					<div class="gallery-item">
						<img src="img/peluqueria.jpg" alt="imagen del negocio" />
					</div>

					<div class="gallery-item">
						<img src="img/P3.jpg" alt="imagen del negocio">
					</div>

					<div class="gallery-item">
						<img src="img/P2.jpg" alt="imagen del negocio">
					</div>

					<div class="gallery-item">
						<img src="img/P1.jpg" alt="imagen del negocio">
					</div>
			...
			<div class="row">
				<div class="col colm-txt">
					<h2 class="fw-bold">
						BarberCool <span class="badge proyect-badge">TOP</span>
				...
				<div class="col colm-txt text-end">
					<a class="btn btn-primary proyect-btn" href="./negocios.html"
						target="_blank" role="button">Ver en Maps</a>
				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<p>Es un servicio de peluquería-spa dedicado a llevar calidad de
								alto nivel para su imagen y cuidado personal, sin
								complicaciones, dándoles todas las facilidades: comodidad,
								satisfacción, atención y cortesía, al lugar que usted desee. Un
								negocio atractivo dado que en el mercado no existe en servicio
								completo y exclusive a domicilio, por lo que se podría llegar a
								obtener una participación de mercado significativa.</p>
							<!-- Aqui la descripcion del negocio-->
							<hr>
							<h4 class="fw-bold">Horario</h4>
							<p>Lunes - Viernes : 8:00AM - 16PM</p>
							<!-- Aqui el horario del negocio -->
							<p>Sabado - Domingo : 10:00AM - 15PM</p>
						</div>
					</div>
